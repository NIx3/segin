...
(k.tipo='A' or k.tipo='B' or k.tipo='C') and k.codigo=a.codigo and a.linea=$linea";
}
if($ca=='1'){
$rrr="Select k.tipo,k.codigo,a.descripcion,k.costou,k.preciou,k.cantidad from kardex k, articulos a where  k.fecha>='$fechai' and k.fecha<='$fechaf' and
(k.tipo='A' or k.tipo='B' or k.tipo='C') and k.codigo=a.codigo and a.linea=$linea and k.serie=1";
}
if($ca=='2'){
$rrr="Select k.tipo,k.codigo,a.descripcion,k.costou,k.preciou,k.cantidad from kardex k, articulos a where  k.fecha>='$fechai' and k.fecha<='$fechaf' and
(k.tipo='A' or k.tipo='B' or k.tipo='C') and k.codigo=a.codigo and a.linea=$linea and k.serie=2";
}
if($ca=='3'){
$rrr="Select k.tipo,k.codigo,a.descripcion,k.costou,k.preciou,k.cantidad from kardex k, articulos a where  k.fecha>='$fechai' and k.fecha<='$fechaf' and
(k.tipo='A' or k.tipo='B' or k.tipo='C') and k.codigo=a.codigo and a.linea=$linea and k.serie=3";
}
if($ca=='4'){
$rrr="Select k.tipo,k.codigo,a.descripcion,k.costou,k.preciou,k.cantidad from kardex k, articulos a where  k.fecha>='$fechai' and k.fecha<='$fechaf' and
(k.tipo='A' or k.tipo='B' or k.tipo='C') and k.codigo=a.codigo and a.linea=$linea and k.serie=4";
}
