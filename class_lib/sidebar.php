<section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="entrada_compra.php"><i class="fa fa-download"></i> Entradas por Compra.</a></li>
                <li><a href="rev_entrada.php"><i class="fa fa-search"></i> Revision de Entradas por Compra.</a></li>
