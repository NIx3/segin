...
/*verifica la caja seleccionada*/
   if($caja=="0"){
    $cadena_contado="Select distinct fecha,serie, numero from kardex where tipo='A' and fecha>='$fi' and fecha<='$ff' order by id";
    $cadena_credito="Select distinct fecha,serie, numero from kardex where tipo='A' and fecha>='$fi' and fecha<='$ff' order by id";
    }
    if($caja=="1"){
    $cadena_contado="Select distinct fecha,serie, numero from kardex where tipo='A' and fecha>='$fi' and fecha<='$ff' and serie=1 order by id";
    $cadena_credito="Select distinct fecha,serie, numero from kardex where tipo='A' and fecha>='$fi' and fecha<='$ff' and serie=1 order by id";
    }
    if($caja=="2"){
    $cadena_contado="Select distinct fecha,serie, numero from kardex where tipo='A' and fecha>='$fi' and fecha<='$ff' and serie=2 order by id";
    $cadena_credito="Select distinct fecha,serie, numero from kardex where tipo='A' and fecha>='$fi' and fecha<='$ff' and serie=2 order by id";
    }
    if($caja=="3"){
    $cadena_contado="Select distinct fecha,serie, numero from kardex where tipo='A' and fecha>='$fi' and fecha<='$ff' and serie=3 order by id";
    $cadena_credito="Select distinct fecha,serie, numero from kardex where tipo='A' and fecha>='$fi' and fecha<='$ff' and serie=3 order by id";
    }
    if($caja=="4"){
    $cadena_contado="Select distinct fecha,serie, numero from kardex where tipo='A' and fecha>='$fi' and fecha<='$ff' and serie=4 order by id";
    $cadena_credito="Select distinct fecha,serie, numero from kardex where tipo='A' and fecha>='$fi' and fecha<='$ff' and serie=4 order by id";
    }
      ...
      if($db->numero_de_registros($exec)>0){
        ...
        echo "<tbody>";
           while($x=$db->buscar_array($exec)){
            ...
            echo "<td>".$fecha."</td>";
            echo "<td>".$s."-".$n."</td>";
            $busca="Select tipo, sum(cantidad*preciou) as monto from kardex where serie=$s and numero=$n and tipo<>'A'";
            $exec_contado=$db->consulta($busca);
             ...
             $busca_cancelacion=$db->consulta("Select id from kardex where serie=$s and numero=$n and tipo='A'");
     ...
     if($db->numero_de_registros($exec_credito)>0){
        ...
        echo "<tbody>";
           while($xx=$db->buscar_array($exec_credito)){
            ...
            $busca_c="Select tipo, sum(cantidad*preciou) as monto from kardex where serie=$s_credito and numero=$n_credito and tipo<>'C'";
            $exec_credito_busca=$db->consulta($busca_c);
             ...
             $busca_cancelacion_credito=$db->consulta("Select id from kardex where serie=$s_credito and numero=$n_credito and tipo='C'");
   ...
   /*pone la tabla de abonos registrados*/
      $busca_abonos=$db->consulta("Select k.fecha,k.preciou,k.serie,k.numero,c.nombre from kardex k,clientes c where k.tipo='A' and k.fecha>='$fi' and k.fecha<='$ff' and k.referencia=c.id");
