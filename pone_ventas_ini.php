...
$consulta=$db->consulta("Select sum(cantidad*preciou) as monto from kardex where (tipo='A' or tipo='B') and fecha='$fecha_actual'");
...
$consulta2=$db->consulta("Select sum(cantidad*preciou) as monto2 from kardex where tipo='A' and fecha='$fecha_actual'");
