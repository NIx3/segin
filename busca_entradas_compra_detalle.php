...
$cadena="Select k.user,k.referencia,k.proveedor,k.codigo,k.cantidad,k.costou,k.descuento_porcentaje,k.impuesto_porcentaje,a.descripcion from kardex k, articulos a where k.tipo='A' and k.numero=$entrada and a.codigo=k.codigo order by k.id";
