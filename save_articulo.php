...
$inserta_articulo="Insert into articulos(codigo,descripcion,costo,precio,proveedor,codigostock,fecha_cad) values(
'$codigo','$descripcion','$costo','$precio','$proveedor','$codigostock','$fecha_caducidad')";
