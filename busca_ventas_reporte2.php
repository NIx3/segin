...
if($tipo=='por_linea'){
  ...
  if($caja=='0'){
    ...
    where (k.tipo='A' or k.tipo='B' or k.tipo='C') and k.fecha>='$fi' and k.fecha<='$ff' and
...
if($tipo=='general'){
 ...
 k.fecha>='$fi' and k.fecha<='$ff' and (k.tipo='A' or k.tipo='BC' or k.tipo='C') and k.codigo=a.codigo";
 }
 if($caja=='1'){
   $b="Select k.tipo,k.cantidad,k.codigo,a.linea,k.costou,k.preciou from kardex k, articulos a where
 k.fecha>='$fi' and k.fecha<='$ff' and (k.tipo='A' or k.tipo='BC' or k.tipo='C') and k.serie=1 and k.codigo=a.codigo";
 }
 if($caja=='2'){
   $b="Select k.tipo,k.cantidad,k.codigo,a.linea,k.costou,k.preciou from kardex k, articulos a where
 k.fecha>='$fi' and k.fecha<='$ff' and (k.tipo='A' or k.tipo='BC' or k.tipo='C') and k.serie=2 and k.codigo=a.codigo";
 }
 if($caja=='3'){
   $b="Select k.tipo,k.cantidad,k.codigo,a.linea,k.costou,k.preciou from kardex k, articulos a where
 k.fecha>='$fi' and k.fecha<='$ff' and (k.tipo='A' or k.tipo='BC' or k.tipo='C') and k.serie=3 and k.codigo=a.codigo";
 }
 if($caja=='4'){
   $b="Select k.tipo,k.cantidad,k.codigo,a.linea,k.costou,k.preciou from kardex k, articulos a where
 k.fecha>='$fi' and k.fecha<='$ff' and (k.tipo='A' or k.tipo='BC' or k.tipo='CT') and k.serie=4 and k.codigo=a.codigo";
 }
